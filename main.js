...
const initGame = () => {
    ...
    if (snakeX === foodX && snakeY === foodY) {
      ...
      highScoreElement.innerText = `High Score: ${highScore}`;
      snakeSpeed -= 1; // Increase the snake's speed by 1 millisecond
      if (snakeSpeed < 40) {
        snakeSpeed = 40; // Ensure the snake does not go too fast
      }     
    }
    //update snake head
    snakeX += velocityX;
    ...
    // Update the interval with the new snake speed
    clearInterval(setIntervalId);
